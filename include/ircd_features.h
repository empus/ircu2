...
enum Feature {
  ...
  FEAT_DNS_TCP_MAXCONN,
  FEAT_AUTH_TIMEOUT,
  FEAT_WEBSOCKET_KEEPALIVE,
  FEAT_WEBSOCKET_ALLOWED_ORIGINS,
  ...
  FEAT_RESUME,
  FEAT_RESUME_TIMEOUT,
  FEAT_RESUME_ALLOW_BRB,
  FEAT_RESUME_MAX_DETACHED,
  FEAT_RESUME_SERVER_NOTICES,
  FEAT_RESUME_AUTO_ACCOUNT,
  FEAT_RESUME_ACCOUNT_ANY_IP,
  FEAT_RESUME_DETACH_PINGOUT,
  FEAT_RESUME_REQUIRE_WEBSOCKET,
